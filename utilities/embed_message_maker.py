...
class MessageMaker():
    def __init__(self, hero_type=None):
        ...
        self.dice_origin_to_9 ={"one": "<:rolled1:1002256566717784074>", "two":"<:rolled2:1002256636066418818>", "three":"<:rolled3:1002256664692535407>", "four": "<:rolled4:1002256500607156264> ", "five": "<:rolled5:1002263017708343336> ", "six":"<:rolled6:1534576500530086081> ","seven": "<:rolled7fail:1533221453758202046>", "eight": "<:rolled8:1002263085597343874> ", "nine": "<:rolled9:1002263106682110013> ", "ten": "<:rolled10:1002264540924358768> "}
        self.dice_demigod_to_9 ={"one": "<:rolled1:1002256566717784074>", "two":"<:rolled2:1002256636066418818>", "three":"<:rolled3:1002256664692535407>", "four": "<:rolled4:1002256500607156264> ", "five": "<:rolled5:1002263017708343336> ", "six":"<:rolled6:1534576500530086081> ", "seven": "<:rolled7:1002263065963802704> ", "eight": "<:rolled8:1002263085597343874> ", "nine": "<:rolled9:1002263106682110013> ", "ten": "<:rolled10:1002264540924358768> "}
        self.dice_god_to_9 ={"one": "<:rolled1:1002256566717784074>", "two":"<:rolled2:1002256636066418818>", "three":"<:rolled3:1002256664692535407>", "four": "<:rolled4:1002256500607156264> ", "five": "<:rolled5:1002263017708343336> ", "six": "<:rolled6sux:1002263051234567890>", "seven": "<:rolled7:1002263065963802704> ", "eight": "<:rolled8:1002263085597343874> ", "nine": "<:rolled9:1002263106682110013> ", "ten": "<:rolled10:1002264540924358768> "}
    ...
    def diceReader(self, results):
        if self.hero_type == "God Feat of Scale":
            dice_to_use = self.dice_god_to_9
        ...
        for dice in results:
            if dice == 1:
                message += dice_to_use["one"]
                message += " "
            if dice == 2:
                message += dice_to_use["two"]
                message += " "
            if dice == 3:
                message += dice_to_use["three"]
                message += " "
            if dice == 4:
                message += dice_to_use["four"]
                message += " "
            if dice == 5:
                message += dice_to_use["five"]
                message += " "
            if dice == 6:
                message += dice_to_use["six"]
                message += " "
            if dice == 7:
                message += dice_to_use["seven"]
                message += " "
            if dice == 8:
                message += dice_to_use["eight"]
                message += " "
            if dice == 9:
                message += dice_to_use["nine"]
                message += " "
            if dice == 10:
